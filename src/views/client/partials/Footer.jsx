...
export default function Footer() {
  return (
    <>
      <footer className="p-14 text-base-content fondo">
        <div className="sm:flex sm:mt-4">
          <div className="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-between">
              ...
              <span className="my-2">
                ...
                >
                  <img
                    ...
                    src="/img/deva_blanco.png"
                    alt=""
                  />
                </a>
              </span>
              <span className="my-2 font-bold text-white">
                <i className="pi pi-map-marker mr-1"></i>
                Ubicación
                <p className="font-normal">
                  Jr. Artesanal MzA_Lt.13_Urb. APIRAJ
                  <br /> Juliaca
                </p>
              </span>
              <span className="my-2 font-bold text-white">
                ...
                Telefonos
                <p className="font-normal">+51 996 030 355</p>
              </span>
              <span className="my-2 font-bold text-white">
            ...
            <div className="flex flex-col">
              ...
              <span className="my-2">
                <a href="/" className="text-white text-md hover:text-green-500">
                  <i className="pi pi-angle-right mr-1"></i>
                  INICIO
                </a>
              </span>
              <span className="my-2">
                <a
                  href="/nosotros"
                  className="text-white text-md hover:text-green-500"
                >
                  <i className="pi pi-angle-right mr-1"></i>
                  NOSOTROS
                </a>
