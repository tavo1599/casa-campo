    ...
    <div className="py-10 relative" ref={sectionRef}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white shadow-lg rounded-lg overflow-hidden cursor-pointer" onClick={() => handleCardClick({ name: 'Oak Cabin', image: cabana1, capacity: '4', rooms: '2', beds: '3', baths: '2', description: 'A cozy oak cabin...', price: 100 })}>
            <img src={cabana1} alt="Cabaña 1" className="w-full h-auto object-cover transform transition duration-300 hover:scale-105" />
            <div className="p-4 text-center">
              <h2 className="text-xl font-bold font-serif">Oak Cabin</h2>
            </div>
          </div>
          <div className="bg-white shadow-lg rounded-lg overflow-hidden cursor-pointer" onClick={() => handleCardClick({ name: 'Maple Cabin', image: cabana2, capacity: '6', rooms: '3', beds: '4', baths: '3', description: 'A spacious maple cabin...', price: 150 })}>
            <img src={cabana2} alt="Cabaña 2" className="w-full h-auto object-cover transform transition duration-300 hover:scale-105" />
            <div className="p-4 text-center">
